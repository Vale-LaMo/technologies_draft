...
temp <- read_delim("round2/output/workshop_individual_ass.csv")[,-1] # all the individual assessments
distinct(temp["technology"]) -> techs
...
while (i <= dim(techs)[1]) {
  ...
  ggsave(paste("round2/figs_techs/ordination_",tech_plot,".tiff",sep=""), 
                dpi=300, compression = 'lzw')
...
ggsave("round2/ordination_centers.tiff",
       dpi=300, compression = 'lzw')
...
ggsave("round2/ordination_centers_criteria.tiff",
       dpi=300, compression = 'lzw')
