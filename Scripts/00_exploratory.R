...
write.csv(temp, "round1/output/assessments_1stRound.csv")
...
write.csv(summary_coders_tech, "round1/output/summary_coders_tech.csv")
...
ggsave("round1/summary_coders_tech.tiff",
...
ggsave("round1/summary_unknowns_detailed.tiff",
       dpi=300, compression = 'lzw')
...
scores_num_long %>% 
  ...
  geom_violin() 
ggsave("round1/criteria_violin.tiff",
       dpi=300, compression = 'lzw')
# balloon plots
scores_num_long %>% 
...
ggsave("round1/criteria_balloon.tiff",
       dpi=300, compression = 'lzw')
